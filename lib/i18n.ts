...
const AR: Record<string, string> = {
  ...
  "stk.total": "المجموع",
  "stk.transferToACity": "نقل المخزون بين المدن",
  "stk.uploadMainWarehouseCount": "رفع جرد المكتب الرئيسي (.xlsx)",
  ...
  "manage.productLine": "خطوط المنتجات",
  "manage.role": "الدور",
  "manage.save": "حفظ",
  ...
  "neworder.outOfStock": "نفد المخزون",
  "neworder.left": "متبقٍ {n}",
  "chat.reply": "رد",
  "chat.messageDirect": "راسل {name} مباشرة",
  "chat.startMeeting": "بدء اجتماع فيديو",
  "chat.videoMeeting": "اجتماع فيديو",
  "chat.join": "انضم",
  "chat.leave": "مغادرة",
  "chat.openInBrowser": "افتح في المتصفح",
  "chat.startNow": "بدء اجتماع الآن",
  "chat.schedule": "جدولة",
  "chat.scheduleHint": "الاجتماع المجدول تُنشر بطاقته الآن ويُنبَّه الجميع عند حلول موعده.",
  "settings.everyoneAuto": "يُحدَّث تلقائياً",
  "settings.groupCreatorIncluded": "أنت مضمَّن في كل مجموعة تنشئها — المجموعة لا يراها إلا أعضاؤها.",
  "neworder.otherProducts": "منتجات أخرى",
  "manage.noLinesYet": "لا توجد خطوط بعد — أضفها من لوحة التحكم.",
  "manage.linesHint": "بدون أي اختيار = يبيع كل الخطوط.",
  "queue.invoicedRecently": "فُوترت خلال آخر 24 ساعة — تراجع إن كانت خطأ",
  "queue.undo": "تراجع",
  "queue.undoConfirm": "التراجع عن هذه الفاتورة؟ يعود المخزون إلى المستودع وتعود الطلبية إلى القائمة.",
  "payroll.undoPay": "التراجع عن هذه الدفعة",
  "payroll.undoPayConfirm": "التراجع عن راتب {name}؟ يعود زر الدفع ويُسجَّل التراجع.",
  "payroll.undoPayoutConfirm": "التراجع عن حوافز {name} الربعية؟ يعود زر الدفع ويُسجَّل التراجع.",
  "chart.collected": "المحصَّل",
  "chart.noData": "لا شيء هذا الشهر بعد.",
  "chart.sales": "المبيعات",
  "chart.salesGrowth": "المبيعات والأموال الواردة — آخر 12 شهراً",
  "chart.salesGrowth12": "نمو المبيعات — آخر 12 شهراً",
  "chart.whoSoldWhat": "من باع ماذا — هذا الشهر",
  "coll.approve": "موافقة",
  "coll.collectorPlans": "خطط جولات المحصّلين بانتظارك",
  "coll.return": "إرجاع",
  "coll.returnPlanWhy": "ما الذي يجب تغييره؟",
  "coll.stops": "محطة",
  "coll.weekOf": "أسبوع",
  "dlib.deliveries": "التسليمات",
  "dlib.delivery": "سُلِّمت",
  "manage.canCollect": "يحصّل الدفعات — أطفئه عندما يغطي محصّل مخصص عملاءه",
  "manage.collector": "محصّل",
  "manage.dragToReorder": "اسحب الصفوف لترتيب المنتجات كما يراها المندوبون — في كل التطبيق.",
  "orders.delivered": "سُلِّمت",
  "orders.deliveries": "التسليمات",
  "orders.markDelivered": "سُلِّمت — صوِّر الفاتورة المختومة",
  "orders.myOrders": "طلباتي",
  "orders.stampedInvoice": "الفاتورة المختومة",
  "orders.uploading": "جارٍ الرفع…",
  "payroll.collPlan": "حافز التحصيل — الهدف والنسب",
  "payroll.collPlanSub": "دون الهدف الشهري يأخذون النسبة الأدنى مما حصّلوه؛ وعند بلوغه أو تجاوزه النسبة الأعلى على كامل المبلغ. الفراغ = نسبة الشركة الموحدة.",
  "payroll.collTarget": "الهدف الشهري",
  "payroll.collectedMtd": "المحصَّل",
  "payroll.pctAbove": "٪ عند/فوق الهدف",
  "payroll.pctBelow": "٪ دون الهدف",
  "queue.pdfFirst": "أرفق ملف الفاتورة PDF أولاً — الزر بجانب التأكيد.",
  "stk.inSource": "في المصدر",
